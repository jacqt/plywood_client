(defproject plywood_client "0.1.0-SNAPSHOT"
  ...
  :uberjar-name "plywood_client.jar"
  ...
  :profiles {:dev {:source-paths ["env/dev/clj"]
                   ...
                   :repl-options {:init-ns plywood-client.server
                   ...
                   :figwheel {:http-server-root "public"
                              ...
                              :ring-handler plywood-client.server/http-handler}
